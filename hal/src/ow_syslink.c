...
{
 0xeb, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x44, 0x00, 0x0e, 0x01, 0x09, 0x62,
 0x63, 0x4c, 0x65, 0x64, 0x52, 0x69, 0x6e, 0x67, 0x02, 0x01, 0x62, 0x55, 0x00
};

static uint8_t dummyData2[] =
{
 0xeb, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0xFE, 0x00, 0x0e, 0x01, 0x09, 0x62,
 0x63, 0x4c, 0x65, 0x64, 0x52, 0x69, 0x6e, 0x67, 0x02, 0x01, 0x62, 0x55, 0x00
};

static uint8_t tbData[] =
{
  0xeb, 0x00, 0x00, 0x00, 0x00, 0xbc, 0xff, 0xaa, 0x00, 0x0c, 0x01, 0x07,
  0x62, 0x63, 0x63, 0x66, 0x32, 0x74, 0x62, 0x02, 0x01, 0x61, 0xbb, 0x00
};
#endif
...
{
 0xeb, 0x00, 0x00, 0x00, 0x00, 0xbc, 0x01, 0xb1, 0x00, 0x0e, 0x01, 0x09, 0x62,
 0x63, 0x4c, 0x65, 0x64, 0x52, 0x69, 0x6e, 0x67, 0x02, 0x01, 0x62, 0x55, 0x00
};
#endif
...
#endif
#ifdef OW_WRITE_TEST
  if (owWrite(0, 0, sizeof(tbData), tbData))
  {
...
//  }
  ...
  if (owWrite(0, 0, sizeof(ledData), ledData))
  {
    DEBUG_PRINT("Write LED [OK].\n");
  }
  else
  {
    DEBUG_PRINT("Write LED [FAIL].\n");
  }
